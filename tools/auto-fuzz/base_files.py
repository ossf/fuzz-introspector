...
def gen_dockerfile(github_url,
    ...
    if language == "python":
        return _gen_dockerfile_python(github_url, project_name, template_dir, project_build_type)
    elif language == "java":
...
def _gen_dockerfile_python(github_url, project_name, template_dir, project_build_type):
