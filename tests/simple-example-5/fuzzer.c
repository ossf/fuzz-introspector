...
void tmp_hello3(char *s) {
  if (valsup++ == 1) printf("%s, sdlkfjgslkdfjgl\n", s);
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
...
static void helloWorld(char *s1, int i2) {
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl %s - %d\n", s1, i2);
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
  if (valsup++ == 1) printf("sdlkfjgslkdfjgl\n");
