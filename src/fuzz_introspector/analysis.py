...
def correlate_introspector_func_to_debug_information_v2(
    ...
    for dfunction in debug_dict_by_filename.get(os.path.normpath(if_func['Functions filename']), []):
        try:
...
def correlate_introspection_functions_to_debug_info_v2(
    ...
    for df in debug_all_functions:
        ...
        df['source']['source_file'] = os.path.normpath(df['source'].get('source_file', ''))
