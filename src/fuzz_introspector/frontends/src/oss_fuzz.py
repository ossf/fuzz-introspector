...
def process_c_project(target_dir, entrypoint):
...
def analyse_folder(language, directory, entrypoint):
    if language == 'c':
        process_c_project(directory, entrypoint)
    if language == 'cpp':
        process_cpp_project(directory, entrypoint)
    if language == 'go':
        process_go_project(directory)
