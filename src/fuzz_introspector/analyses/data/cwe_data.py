...
SINK_FUNCTION: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    'CWE787': {
        ...
        'sink': {
            'c-cpp': [
                ...
                ('', 'calloc'), ('', 'realloc'), ('', 'strcpy'),
                ('', 'strcpy_s'), ('', 'strncpy'), ('', 'strncpy_s'),
                ('', 'strcat'), ('', 'strcat_s'), ('', 'strncat'),
                ('', 'strncat_s'), ('', 'strxfrm'), ('', 'strdup'),
                ('', 'strndup'), ('', 'memchr'), ('', 'memset'),
                ('', 'memset_explicit'), ('', 'memset_s'),
                ('', 'memcpy'), ('', 'memcpy_s'), ('', 'memmove'),
                ('', 'memmove_s'), ('', 'memccpy'), ('', 'putc'),
                ('', 'fputc'), ('', 'putchar'), ('', 'puts'),
                ('', 'put'), ('', 'fwrite'), ('', 'ungetc'),
                ('', 'fputwc'), ('', 'putwc'), ('', 'fputws'),
                ('', 'putwchar', ('', 'ungetwc')],
    ...
    'CWE89': {
        ...
        'sink': {
            ...
            'jvm': [('java.sql.Statement', 'execute'),
    ...
    'CWE20': {
        ...
        'sink': {
            ...
            'jvm': [
                ...
                ('java.io.BufferedReader', 'readLine'), ('java.lang.System', 'getenv'),
    ...
    'CWE22': {
        ...
        'sink': {
            ...
            'jvm': [
                ...
                ('java.io.BufferedReader', '<init>'), ('java.nio.file.Paths', 'get'),
                ...
                ('java.nio.file.Files', 'write'), ('java.io.File', 'createNewFile'),
